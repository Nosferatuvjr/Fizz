...
##   Author 	: 	Vivaldo Júnior 
##   Version 	: 	3.0
##   Github 	: 	https://github.com/Nosferatuvjr
...
banner() {
	cat <<- EOF
		...
		${ORANGE}  		______  _
		${ORANGE}		|  ____|(_)
		${ORANGE}		| |__    _  ____ ____
		${ORANGE}		|  __|  | ||_  /|_  /
		${ORANGE}		| |     | | / /  / /
		${ORANGE}		|_|     |_|/___|/___|          ${RED}Version : 1.0

		${GREEN}[${WHITE}-${GREEN}]${CYAN} Tool Created by Nosferatuvjr (amazonasdev.com)${WHITE}
	EOF
}
